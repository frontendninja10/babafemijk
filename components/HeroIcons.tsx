...
const logos = [
  ...
  { id: 2, component: NextLogo },
  { id: 3, component: FigmaLogo },
  { id: 4, component: TailwindLogo },
  { id: 5, component: CSSLogo },
  { id: 6, component: htmlLogo },
  { id: 7, component: gitHubLogo },
  { id: 8, component: typeScriptLogo },
  { id: 9, component: javaScriptLogo },
];

const shuffle = (
  array: { id: number; component: () => React.JSX.Element }[]
) => {
  return array.sort(() => Math.random() - 0.5);
};

export default function GridReorder() {
  const [items, setItems] = useState(logos); // Initialize with the logos array
...
function typeScriptLogo() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="64" // Set width to match JS icon
      height="56" // Set height to match JS icon
      viewBox="0,0,256,256"
    >
...
function TailwindLogo() {
  return (
    ...
    >
      <path
        d="M16.001 6.40051C11.7342 6.40051 9.06848 8.53301 8.00098 12.7998C9.60048 10.667 11.4677 9.86726 13.6005 10.4005C14.8182 10.704 15.6885 11.587 16.6522 12.5655C18.2207 14.1573 20.0362 16 24.001 16C28.2675 16 30.9335 13.8673 32.001 9.59951C30.4012 11.7335 28.5342 12.5333 26.4012 12C25.1837 11.6963 24.3145 10.8135 23.3495 9.83501C21.782 8.24326 19.967 6.40051 16.001 6.40051V6.40051ZM8.00098 16C3.73448 16 1.06848 18.1328 0.000976562 22.4005C1.60048 20.2665 3.46748 19.4668 5.60048 20C6.81823 20.3038 7.68848 21.1865 8.65223 22.165C10.2207 23.7568 12.0362 25.5995 16.001 25.5995C20.2675 25.5995 22.9335 23.467 24.001 19.2003C22.4012 21.333 20.5342 22.1328 18.4012 21.5995C17.1837 21.296 16.3145 20.413 15.3495 19.4345C13.782 17.8428 11.967 16 8.00098 16Z"
        fill="#64748b"
      />
    </svg>
  );
