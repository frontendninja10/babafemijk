...
In this example, we have a list of goals. We can add a new goal to the list by clicking the "Add to list" button. The goal is added to the list and the input field is cleared. State is used to store the list of goals and the new goal.
